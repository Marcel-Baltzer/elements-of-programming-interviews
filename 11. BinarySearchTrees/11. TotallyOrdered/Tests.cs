...
namespace Elements_of_Programming_Interviews._11._BinarySearchTrees._11._TotallyOrdered
{
    ...
    {
        [Fact]
        public void PairIncludesAncestorAndDescendant0Fm()
        {
            ...
            var result = Solution.PairIncludesAncestorAndDescendant0Fm(A, K, J);
            result.Should().BeTrue();
            
            result = Solution.PairIncludesAncestorAndDescendant0Fm(I, M, J);
            result.Should().BeTrue();
            
            result = Solution.PairIncludesAncestorAndDescendant0Fm(I, P, J);
            result.Should().BeFalse();
            
            result = Solution.PairIncludesAncestorAndDescendant0Fm(J, K, J);
            result.Should().BeFalse();
        }
    }
}