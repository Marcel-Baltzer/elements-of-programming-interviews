...
namespace Elements_of_Programming_Interviews._11._BinarySearchTrees._12._RangeLookupProblem
{
    ...
    {
        [Fact]
        public void RangeLookupInBinarySearchTree()
        {
            ...
            var interval = new Solution.Interval(16, 31);

            var result = Solution.RangeLookupInBinarySearchTree(A, interval);

            var expectedResult = new List<int> {17, 19, 23, 29, 31};
