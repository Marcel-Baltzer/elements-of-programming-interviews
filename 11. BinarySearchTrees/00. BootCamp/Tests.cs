...
namespace Elements_of_Programming_Interviews._11._BinarySearchTrees._00._BootCamp
{
    ...
    {
        [Fact]
        public void SearchBinarySearchTree()
        {
            ...
            var result = Solution.SearchBinarySearchTree(A, 37);
            result.Should().BeEquivalentTo(K);

            result = Solution.SearchBinarySearchTree(A, 99);
